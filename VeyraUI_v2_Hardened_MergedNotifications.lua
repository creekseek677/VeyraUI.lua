--[[
	VeyraUI v2 Hardened + Improved Notifications - Single File
...
function NotificationManager:Notify(config)
	...
	-- Main frame — large rounded corners + soft black→white gradient
	...
	corner.CornerRadius = UDim.new(0, NOTIF_CORNER)
	corner.Parent = frame
	...
	headerCorner.CornerRadius = UDim.new(0, NOTIF_CORNER)
	headerCorner.Parent = header

	-- Fix bottom of header so only top is rounded
